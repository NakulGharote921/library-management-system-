...
import { DEFAULT_COVER } from '../../../../../utils/bookCovers.js';
    ...
    const inner = (
      <span className={innerClass}>
        <img
          ...
          decoding="async"
          draggable={false}
          onError={(e) => { if (e.currentTarget.src !== DEFAULT_COVER) { e.currentTarget.onerror = null; e.currentTarget.src = DEFAULT_COVER } }}
          className={imgClass}
        />
