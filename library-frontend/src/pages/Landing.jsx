...
const FEATURES = [
  ...
  { icon: CreditCard, title: 'Fines & Payments', desc: 'Automated fine calculation with secure online payments via Razorpay.' },
...
const FAQS = [
  ...
  { q: 'How do fines and payments work?', a: 'Overdue books accrue fines automatically. Members can pay instantly and securely online through Razorpay, and admins can track every transaction in the Payments dashboard.' },
