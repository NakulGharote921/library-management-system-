  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 animate-fadeIn">
      <div className="text-center">
        ...
        <p className="mt-2 text-gray-500 dark:text-gray-400">A modern library management system for the digital age</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage your complete book catalog with ease</p>
        </div>
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <Users className="h-8 w-8 text-primary-600" />
          <h3 className="mt-3 font-semibold text-gray-900 dark:text-gray-50">Member Management</h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Track members, loans, and reading history</p>
        </div>
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Different views for guests, members, and admins</p>
        </div>
      </div>
    </div>
  )
