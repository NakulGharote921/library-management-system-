      ...
      <div className="w-full max-w-md animate-fadeIn">
        <div className="rounded-3xl bg-white p-8 shadow-2xl dark:bg-gray-900">
          <div className="mb-8 text-center">
            ...
            <h1 className="mt-4 text-2xl font-bold text-gray-900 dark:text-gray-50">Create Account</h1>
            <p className="mt-1 text-sm text-gray-500">Join the library network</p>
          </div>
